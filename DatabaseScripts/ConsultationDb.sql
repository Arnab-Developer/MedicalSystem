...
CREATE DATABASE [ConsultationDb]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'ConsultationDb', FILENAME = N'[provide local path]' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'ConsultationDb_log', FILENAME = N'[provide local path]' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
GO

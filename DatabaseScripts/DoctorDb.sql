...
CREATE DATABASE [DoctorDb]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'DoctorDb', FILENAME = N'' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'DoctorDb_log', FILENAME = N'' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
GO
